    ...
    echo '<table>';
        echo '<thead>';
            echo '<tr>';
                echo '<td>Username</td>';
                echo '<td>Password</td>';
                echo '<td>Origin E-mail</td>';
                echo '<td>Current E-mail</td>';
                echo '<td>First Name</td>';
                echo '<td>Middle Name</td>';
                echo '<td>Last Name</td>';
                echo '<td>Original Member</td>';
        ...
        if($member_type != ''){
            $count++;
                ...
                switch ($member_type) {
                    ...
                    case 'Life Associate':
                        $plan_id = 799;
                        $member_typec = 'Life Associate';
                        break;
                    case 'Family Life':
                        $plan_id = 799;
                        $member_typec = 'Life Associalte';
                        break;
                    case 'Overseas':
                        $plan_id = 800;
                        $member_typec = 'Overseas';
                        break;
                    case 'Institution':
                        $plan_id = 801;
                        $member_typec = 'Institution';
                        break;
                    case 'Institution Canada':
                        $member_typec = 'Institution';
                        $plan_id = 801;
                ...
                // }  
                echo '<tr>';
                echo '<td>'.$usuario->user_login.'</td>';
                echo '<td>.acgs.2018.</td>';
                echo '<td>'.$usuario->origin_email.'</td>';
                echo '<td>'.$usuario->user_email.'</td>';
                echo '<td>'.$usuario->first_name.'</td>';
                echo '<td>'.$usuario->middle_name.'</td>';
                echo '<td>'.$usuario->last_name.'</td>';
                echo '<td>'.$member_type.'</td>';
                echo '<td>'.$member_typec.'</td>';
                echo '<td>'.$usuario->billing_address_1.'</td>';
                echo '<td>'.$usuario->billing_address_2.'</td>';
                echo '<td>'.$usuario->billing_city.'</td>';
                echo '<td>'.$usuario->billing_state.'</td>';
                echo '<td>'.$usuario->billing_country.'</td>';
                echo '<td>'.$usuario->billing_postcode.'</td>';
                echo '<td>'.$usuario->billing_phone.'</td>';
                echo '<td>'.$origin_date.'</td>';
                echo '<td>'.$end_date.'</td>';
            echo '</tr>'; 
        }
    }
