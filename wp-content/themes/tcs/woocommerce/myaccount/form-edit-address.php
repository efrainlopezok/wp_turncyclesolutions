...
<div class="custom-content-account">
	<ul class="my-account-tabs desktop-show">
		...
		<li><a href="<?php echo get_site_url();?>/my-account/edit-address/billing/" class="active">MY ADDRESS</a></li>
	</ul>
	<div class="my-tabs mobile-show">
		...
		<div class="dropdown-tabs">
			...
			<div><a href="<?php echo get_site_url();?>/my-account/edit-address/billing/" class="active">MY ADDRESS</a></div>
		</div>
	</div>
</div>
