...
function ndss_text_widget() {
    register_widget( 'ndss_text_widget' );
}
add_action( 'widgets_init', 'ndss_text_widget' );
 
// Creating the widget 
class ndss_text_widget extends WP_Widget {
...
__('NDSS Text Widget', 'ndss_text_widget_domain'), 
 
// Widget description
array( 'description' => __( 'NDSS Text Widget to put your content', 'ndss_text_widget_domain' ), ) 
);
}
...
} // Class ndss_text_widget ends here